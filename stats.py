...
if __name__ == '__main__':
    ...
    all_words = []
    all_bigrams = []
    with open('nikita3-processed.csv', 'r') as csv:
        lines = csv.readlines()
    ...
    with open('nikita3' + '-unique.txt', 'w') as uwf:
        uwf.write('\n'.join(unique_words))
    ...
    pkl_file_name = 'nikita3' + '-freqdist.pkl'
    ...
    bi_pkl_file_name = 'nikita3' + '-freqdist-bi.pkl'
